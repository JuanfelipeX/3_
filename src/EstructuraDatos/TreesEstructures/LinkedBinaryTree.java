 ...
 */
package Estructuras.TreesEstructures;
...
public class LinkedBinaryTree implements BinaryTree {
   ...
   public static void main(String [] args)
   {
      LinkedBinaryTree a = new LinkedBinaryTree(),
                       ...
                       k = new LinkedBinaryTree(),
                       z = new LinkedBinaryTree(),
                       l = new LinkedBinaryTree(),
                       m = new LinkedBinaryTree(),
                       s = new LinkedBinaryTree();
      
      x.makeTree(new String("x"), y, z);
      y.makeTree(new String("y"), k, a);
      k.makeTree(new String("k"), a, a);    
      z.makeTree(new String("z"), l, m);
      m.makeTree(new String("m"), a, a);
      l.makeTree(new String("l"), s, a);
      s.makeTree(new String("s"), a, a);
      ...
      System.out.println("Number of nodes = " + x.size());
